...
import com.plotori.develop.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/weekly-prompt").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/submissions/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/submissions/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/submissions/*/reviews").authenticated()
